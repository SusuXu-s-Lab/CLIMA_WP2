...
ground_truth_network = pd.read_csv("ground_truth_network_raw.csv")
household_features = pd.read_csv("household_features_raw.csv")
household_locations = pd.read_csv("household_locations_raw.csv")
household_states = pd.read_csv("household_states_raw.csv")
observed_network = pd.read_csv("observed_network_raw.csv")
