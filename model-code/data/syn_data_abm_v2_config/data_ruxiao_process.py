...
filename = ["ABM_Dense_HighSeed_A", "ABM_Dense_HighSeed_B",
            "ABM_Dense_LowSeed_A", "ABM_Dense_LowSeed_B",
            "ABM_Medium_HighSeed_A", "ABM_Medium_HighSeed_B",
            "ABM_Medium_LowSeed_A", "ABM_Medium_LowSeed_B",
            "ABM_Sparse_HighSeed_A", "ABM_Sparse_HighSeed_B",
            "ABM_Sparse_LowSeed_A", "ABM_Sparse_LowSeed_B"]

filename = ["ABM_Dense_HighSeed_A", 
            "ABM_Dense_LowSeed_A", 
            "ABM_Medium_HighSeed_A", 
            "ABM_Medium_LowSeed_A", 
            "ABM_Sparse_HighSeed_A", 
            "ABM_Sparse_LowSeed_A"]

filename = [ "ABM_Dense_LowSeed_B"]
for f in filename:
    ...
    ground_truth_network = pd.read_csv(os.path.join(data_dir, "ground_truth_network.csv"))
    household_features = pd.read_csv(os.path.join(data_dir, "household_features.csv"))
    household_locations = pd.read_csv(os.path.join(data_dir, "household_locations.csv"))
    household_states = pd.read_csv(os.path.join(data_dir, "household_states.csv"))
    observed_network = pd.read_csv(os.path.join(data_dir, "observed_network.csv"))
    ...
    all_household_ids.update(household_states['household_id'].unique())
    ...
    household_states_processed['household_id'] = household_states_processed['household_id'].map(id_mapping)
