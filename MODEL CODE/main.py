...
def generate_or_load_data(data_dir: str = 'data/syn_data_v1', regenerate: bool = False) -> Dict[str, Any]:
    ...
    data_files = [
        'household_states.csv',
        'household_features.csv', 
        'household_locations.csv',
    ...
    # Load data
    print("Loading data...")
    loader = DataLoader(data_dir, device='cpu')
...
def create_models(data: Dict[str, Any], L: int) -> Dict[str, Any]:
    ...
    network_type_nn = NetworkTypeNN(feature_dim=feature_dim, L=L, hidden_dim=64)
...
def train_model(data: Dict[str, Any], loader: DataLoader, inference_components: Dict[str, Any],
    ...
    if use_mini_batch:
        ...
        batch_size = min(50, n_households // 2)  # Adaptive batch size
...
def save_model_and_results(models: Dict[str, Any], inference_components: Dict[str, Any],
    ...
    # Save complete model
    model_path = 'saved_models/trained_model_L_3_parameter_range_reconfig.pth'
    torch.save({
    ...
    history_path = 'logs/training_history_L_3_parameter_range_reconfig.json'
