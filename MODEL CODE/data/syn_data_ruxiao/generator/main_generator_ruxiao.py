...
df_ori = pd.read_csv('/Users/susangao/Desktop/CLIMA/CODE 3/data/syn_data_ruxiao/generator/household_swinMaryland_20190101.csv')
...
Save Results
'''
folder_path = '/Users/susangao/Desktop/CLIMA/CODE 4/data/syn_data_ruxiao/'
...
house_df.to_csv(folder_path+'household_loactions_raw.csv',index=False)
