...
class MeanFieldPosterior:
    """
    Updated mean-field variational posterior following PDF formulation.
    ...
    def _compute_marginal_probabilities_timestep(self,
        ...
        t=0: π̄_ij(0) = π_ij(0) (from conditional with dummy previous type)
        ...
        for idx, (i, j) in enumerate(pairs_t):
            if t == 0:
                ...
                # π̄_ij(t)[k] = Σ_{k'} π̄_ij(t-1)[k'] * π_ij(t | k')[k]
