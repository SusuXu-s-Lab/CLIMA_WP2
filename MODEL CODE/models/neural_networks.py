...
class SelfActivationNN(nn.Module):
    """NN_self: Input [x_i(t), s_i(t:t-L+1)^{-k}, k, t] """
...
class InfluenceNN(nn.Module):
    """NN_influence: Input [l_ij(t), s_j^{-k}, s_i^{-k}, f_ij(t), dist_ij, k, t] """
...
class InteractionFormationNN(nn.Module):
    """NN_form: Input [f_ij(t), s_i(t), s_j(t), dist_ij] """
...
class InfluenceNN(nn.Module):
    """NN_influence: Input [l_ij(t), s_j^{-k}, s_i^{-k}, f_ij(t), dist_ij, k, t] - unchanged"""
